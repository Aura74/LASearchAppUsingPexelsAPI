...
const apikey = "L5sZZRBuyT1JV364j7jsz0SnJUkxf5zrQNmafq5KziatGOWSYEBcW1KN"; //use the apikey you have generated
...
function display_images(response) {
  ...
  response.photos.forEach((image) => {
    ...
    photo.innerHTML = `<a href="${image.url}">
    <img src="${image.src.large}">
  </a>
        <figcaption> Skapat av: ${image.photographer} 📸
        </figcaption>
        `;
